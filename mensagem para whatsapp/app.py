...
for linha in pagina_clientes.iter_rows(min_row=2):
    ...
    mensagem = f'Olá {nome} seu pix vence no dia {vencimento.strftime("%d/%m/%Y")}. Favor pagar no link https://www.link_do_pagamento.com'
    ...
    try:
        ...
        sleep(10)
        seta = pyautogui.locateCenterOnScreen('seta') #não funcionou coom a imagem, melhor usar  a seta
        sleep(5)
